...
var (
	_ QueryArgsContexter       = (*OptionalDriverAgentDB)(nil)
	_ ExecArgsContexter        = (*OptionalDriverAgentDB)(nil)
	_ StatementQueryArgsExecer = (*optionalDriverAgentSession)(nil)
	_ StatementExecArgsExecer  = (*optionalDriverAgentSession)(nil)
)
