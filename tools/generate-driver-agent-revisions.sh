...
sqlserver:internal/db/query_args_impl_sqlserver.go|\
sqlite:internal/db/sqlite_impl.go|\
sqlite:internal/db/query_args_impl_sqlite.go|\
...
duckdb:internal/db/query_args_impl_duckdb.go|\
dameng:internal/db/dameng_impl.go|\
dameng:internal/db/dameng_metadata.go|\
dameng:internal/db/query_args_impl_dameng.go|\
kingbase:internal/db/kingbase_impl.go|\
kingbase:internal/db/kingbase_identifier_utils.go|\
kingbase:internal/db/query_args_impl_kingbase.go|\
highgo:internal/db/highgo_impl.go|\
highgo:internal/db/query_args_impl_highgo.go|\
vastbase:internal/db/vastbase_impl.go|\
vastbase:internal/db/query_args_impl_vastbase.go|\
...
trino:internal/db/query_args_impl_trino.go)
      return 0
      ;;
  esac
