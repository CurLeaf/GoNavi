...
export const applyMySQLUnsignedColumnTypeInput = (previousType: string, nextInput: string): string => (
  setMySQLUnsignedColumnType(
    nextInput,
    normalizeMySQLUnsignedColumnType(previousType).unsigned
      || normalizeMySQLUnsignedColumnType(nextInput).unsigned,
  )
);
